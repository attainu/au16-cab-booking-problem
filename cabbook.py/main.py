...
def Main_Interface():
    ...
    print("\n*******_____Welcome to the world of SAFARI_____*******\n")
    user = int(input("Please enter 1 if you are a rider\nPlease enter 2 if you are a driver\nPlease enter 3 if you are an administrator\nPlease enter 4 if you want to exit from application\n"))
    if user == 1:
        Rider_Interface()
